...
class Protocol(FusionApi):
    ...
    def get_image_dir(self):
        if self.test is False:
            ...
            f = open(os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "endpoint_outputs", "dataset.json"))
    ...
    def image_acquisition(self, img_path, protocol_name):
        ...
        if self.test is False:
            ...
            img = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "test_rn", "2024-03-05", "rawtake_n7_well0-0_zheigth452.ims")
